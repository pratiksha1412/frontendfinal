  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
      ...
      <li><a href="login.jsp"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>
       <li><a href="cart.jsp"><span class="glyphicons glyphicons-shopping-cart"></span> Cart</a></li>
...
<div class="navbar navbar-inverse  navbar-fixed-bottom" role="navigation">
  <div class="container">
    ...
    <a href="https://www.facebook.com/"><i class="fa fa-facebook-square fa-2x"></i></a>
     <a href="https://twitter.com/login"><i class="fa fa-twitter fa-2x"></i></a>
      <a href="https://twitter.com/GooglePlus?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor"><i class="fa fa-google-plus fa-2x"></i></a>
    </div>
    </div>
    </div>
